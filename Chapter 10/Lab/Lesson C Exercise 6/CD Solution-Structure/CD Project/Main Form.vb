...
' Programmer:   Chris Golpashin due on 10/1/15 @ 11:59 PM
...
Public Class frmMain
    ' structure that is used to replace three former variables that were in btnAdd.
    Structure CDs
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        ...
        ' declare variables
        Dim addingCDs As CDs ' structure variable 
        Dim strConcatenatedInfo As String
        Dim dblPrice As Double
        ' get the CD information
        addingCDs.strName = InputBox("CD name:", "CD Collection")
        addingCDs.strArtist = InputBox("Artist:", "CD Collection")
        addingCDs.strPrice = InputBox("Price:", "CD Collection")
        ...
        Double.TryParse(addingCDs.strPrice, dblPrice)
        addingCDs.strPrice = dblPrice.ToString("N2")
        strConcatenatedInfo = addingCDs.strName.PadRight(40) &
            addingCDs.strArtist.PadRight(25) & addingCDs.strPrice.PadLeft(5)
